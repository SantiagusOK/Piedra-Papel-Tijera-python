...
class Entrada_texto:
    def __init__(self):
        ...
        self.boton_entry1 = Button(ventana,text="Aceptar",command=self.nombrar_tu)
        self.boton_entry2 = Button(ventana,text="Aceptar",command=self.nombrar_op)

    def mostrar_entradas_Y_botones(self):
        self.boton_entry1.place(x=523,y=251)
        self.boton_entry2.place(x=523,y=376)
        self.entry_tu.place(x=325,y=255)
        self.entry_op.place(x=325,y=380)

    def quitar_entradas_y_botones(self):
        self.boton_entry1.place_forget()
        self.boton_entry2.place_forget()
    ...
    def nombrar_op(self):
        ...
        if self.nombre_op == "":
            juego.nombre = "Player 2"
        else:
            juego.nombre = self.nombre_op
...
class Fin_partida:
    def boton_fin_partida(self):
        self.boton_JugarDeNuevo = tk.Button(image=imagen_bJugarDeNuevo,height=173,width=245,bg="white",relief="flat",
        borderwidth=0,command=self.quitar_y_empezar)
        self.boton_JugarDeNuevo.place(x=1035,y=547)

        self.boton_salirPartida = tk.Button(image=imagen_bsalirPartida,height=173,width=245,bg="white",relief="flat",
        borderwidth=0)
...
class Menu:
    ...
    def mostrar_botones_menu(self):
        self.boton_jugar = tk.Button(image=imagen_bjugar,height=214,width=303,bg="white",relief="flat",
        borderwidth=0,command=quitar_y_empezar_ronda)
        self.boton_jugar.place(x=493,y=336)

        self.boton_salir = tk.Button(image=imagen_bsalir,height=75,width=107,bg="white",relief="flat",
        borderwidth=0,command=salir)
        self.boton_salir.place(x=14,y=14)

        self.boton_estadisticas = tk.Button(image=imagen_bEstadisticas,height=214,width=303,bg="white",relief="flat",
        borderwidth=0,command=estadisticas)
        self.boton_estadisticas.place(x=808,y=336)

        self.boton_config = tk.Button(image=imagen_bconfig,height=214,width=303,bg="white",relief="flat",
        borderwidth=0,command=configuracion)
...
class Botones_partida:
    ...
    def mostrar_botones_juego(self):
        self.boton_piedra = tk.Button(image=imagen_bpiedra,height=136,width=400,bg="black",relief="flat",borderwidth=0,command=piedra)
        self.boton_piedra.place(x=30,y=570)
        
        self.boton_papel = tk.Button(image=imagen_bpapel,height=136,width=400,bg="black",relief="flat",
        borderwidth=0,command=papel)
        self.boton_papel.place(x=440,y=570)
        
        self.boton_tijera = tk.Button(image=imagen_btijera,height=136,width=400,bg="black",relief="flat",
    ...
    def quitar_iluminar_boton_piedra(self,event):
        self.boton_piedra.configure(image=imagen_bpiedra)
    ...
    def quitar_iluminar_boton_papel(self,event):
        self.boton_papel.configure(image=imagen_bpapel)
    ...
    def quitar_iluminar_boton_tijera(self,event):
        self.boton_tijera.configure(image=imagen_btijera)
...
class Botones_Fondos:
    def __init__(self):
        self.fondo_elegido = "fondo1"
    
    def mostrar_botones_fondos(self):
        self.boton_fondo1 = Button(ventana,image=imagen_bfondo1,height=116,width=205,borderwidth=0,relief="flat",bg="black",command=self.eleccion_fondo1)
        self.boton_fondo1.place(x=208,y=452)

        self.boton_fondo2 = Button(ventana,image=imagen_bfondo2,height=116,width=205,borderwidth=0,relief="flat",bg="black",command=self.eleccion_fondo2)
        self.boton_fondo2.place(x=429,y=452)

        self.boton_fondo3 = Button(ventana,image=imagen_bfondo3,height=116,width=205,borderwidth=0,relief="flat",bg="black",command=self.eleccion_fondo3)
        self.boton_fondo3.place(x=656,y=452)

        self.boton_fondo4 = Button(ventana,image=imagen_bfondo4,height=116,width=205,borderwidth=0,relief="flat",bg="black",command=self.eleccion_fondo4)
        self.boton_fondo4.place(x=206,y=587)

        self.boton_fondo5 = Button(ventana,image=imagen_bfondo5,height=116,width=205,borderwidth=0,relief="flat",bg="black",command=self.eleccion_fondo5)
        self.boton_fondo5.place(x=429,y=587)

        self.boton_fondo6 = Button(ventana,image=imagen_bfondo6,height=116,width=205,borderwidth=0,relief="flat",bg="black",command=self.eleccion_fondo6)
    ...
    def dibujar_marco_seleccion(self):
        if self.fondo_elegido == "fondo1":
            self.boton_fondo1.configure(image=imagen_bfondo1_select)
            self.fondo_elegido = "fondo1"
        else:
            self.boton_fondo1.configure(image=imagen_bfondo1)
            
        if self.fondo_elegido == "fondo2":
            self.boton_fondo2.configure(image=imagen_bfondo2_select)
            self.fondo_elegido = "fondo2"
        else:
            self.boton_fondo2.configure(image=imagen_bfondo2)       

        if self.fondo_elegido == "fondo3":
            self.boton_fondo3.configure(image=imagen_bfondo3_select)
            self.fondo_elegido = "fondo3"
        else:
            self.boton_fondo3.configure(image=imagen_bfondo3)

        if self.fondo_elegido == "fondo4":
            self.boton_fondo4.configure(image=imagen_bfondo4_select)
            self.fondo_elegido = "fondo4"
        else:
            self.boton_fondo4.configure(image=imagen_bfondo4)

        if self.fondo_elegido == "fondo5":
            self.boton_fondo5.configure(image=imagen_bfondo5_select)
            self.fondo_elegido = "fondo5"
        else:
            self.boton_fondo5.configure(image=imagen_bfondo5)

        if self.fondo_elegido == "fondo6":
            self.boton_fondo6.configure(image=imagen_bfondo6_select)
            self.fondo_elegido = "fondo6"       
        else:
            self.boton_fondo6.configure(image=imagen_bfondo6)
#----------------------------------------------------------------------------------------
barra_textos = Entrada_texto()
sumar_estadisticas = EstadisticasDelJuego()
estadisticas_gui = EstadisticasGUI()
botones_fondo = Botones_Fondos()
botones_config = Botones_Configuracion()
reproductor = Musica_fondo()
rondas = Rondas()
botones_fin = Fin_partida()
botones_menu = Menu()
puntos = Puntuación()
juego = Ppt()
botones = Botones_partida()
#--------------------------------------------------------------FUNCIONES--------------------------------#
def piedra():
    sumar_estadisticas.piedra_tu += 1
    reproductor.sonar_seleccion2()
    botones.quitar_botones_juego()
...
#------------------------------imagenes------------------------------#
#---botones------
imagen_bpiedra = PhotoImage(file="sprites/botones/partida/boton_piedra_spr.png")
imagen_bpapel = PhotoImage(file="sprites/botones/partida/boton_papel_spr.png")
imagen_btijera = PhotoImage(file="sprites/botones/partida/boton_tijera_spr.png")
imagen_bJugarDeNuevo = PhotoImage(file="sprites/botones/partida/boton_JugarDeNuevo_spr.png")
imagen_bsalirPartida = PhotoImage(file="sprites/botones/partida/boton_salirpartida_spr.png")
imagen_bsalir = PhotoImage(file="sprites/botones/menu/boton_salir_spr.png")
imagen_bjugar = PhotoImage(file="sprites/botones/menu/boton_jugar_spr.png")
imagen_bEstadisticas = PhotoImage(file="sprites/botones/menu/boton_estadisticas_spr.png")
imagen_bconfig = PhotoImage(file="sprites/botones/menu/boton_config_spr.png")
...
imagen_bfondo1 = PhotoImage(file="sprites/botones/config/boton_fondo1.png")
imagen_bfondo1_select = PhotoImage(file="sprites/botones/config/boton_fondo1_select.png")
imagen_bfondo2 = PhotoImage(file="sprites/botones/config/boton_fondo2.png")
imagen_bfondo2_select = PhotoImage(file="sprites/botones/config/boton_fondo2_select.png")
imagen_bfondo3 = PhotoImage(file="sprites/botones/config/boton_fondo3.png")
imagen_bfondo3_select = PhotoImage(file="sprites/botones/config/boton_fondo3_select.png")
imagen_bfondo4 = PhotoImage(file="sprites/botones/config/boton_fondo4.png")
imagen_bfondo4_select = PhotoImage(file="sprites/botones/config/boton_fondo4_select.png")
imagen_bfondo5 = PhotoImage(file="sprites/botones/config/boton_fondo5.png")
imagen_bfondo5_select = PhotoImage(file="sprites/botones/config/boton_fondo5_select.png")
imagen_bfondo6 = PhotoImage(file="sprites/botones/config/boton_fondo6.png")
imagen_bfondo6_select = PhotoImage(file="sprites/botones/config/boton_fondo6_select.png")
#---fondos------
